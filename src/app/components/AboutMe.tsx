  ...
  return (
    <section id="about" className="flex min-h-screen">
      ...
      <div className="w-2/3 p-12 flex flex-col justify-center bg-white">
        <h1 className="text-6xl font-bold mb-4 text-black">Olá</h1>
        <p className="text-xl font-light mb-8 text-black">Meu perfil e meus projetos</p>
        <div className="flex space-x-4 mb-8">
          <a href="#curriculo" className="px-6 py-3 bg-blue-800 text-white rounded hover:bg-blue">Currículo</a>
